...
# For simplicity, just support one note per word. 
# Add functionality for longer notes, e.g. Am, A#, Amaj. 

filename = '/Users/soren/Documents/Coding/guitar-lyric-chord-aligner/song.txt'
chords_list = []
